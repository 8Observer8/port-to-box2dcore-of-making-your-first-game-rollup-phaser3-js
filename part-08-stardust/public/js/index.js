import { b2ContactListener, b2BodyType, b2Vec2, b2World, b2PolygonShape, b2CircleShape, DrawShapes } from '@box2d/core';
...
function create() {
    ...
    const contactListener = new ContactListener(starFixtures);
